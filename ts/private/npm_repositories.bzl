...
load("@bazel_tools//tools/build_defs/repo:utils.bzl", "maybe", "patch")
...
def npm_dependencies(ts_version_from = None, ts_version = None, ts_integrity = None, patches = None, patch_args = None):
